...
st.markdown('<a href="#" style="display: block; text-decoration: none; color: #2E6EFF; padding: 1rem; border: 1px solid #e0e0e0; border-radius: 8px; margin-bottom: 1rem;" onmouseover="this.style.textDecoration=\'underline\'; this.style.cursor=\'pointer\';" onmouseout="this.style.textDecoration=\'none\';">How much does home care cost?</a>', unsafe_allow_html=True)
st.markdown('<a href="#" style="display: block; text-decoration: none; color: #2E6EFF; padding: 1rem; border: 1px solid #e0e0e0; border-radius: 8px; margin-bottom: 1rem;" onmouseover="this.style.textDecoration=\'underline\'; this.style.cursor=\'pointer\';" onmouseout="this.style.textDecoration=\'none\';">Can VA help with costs?</a>', unsafe_allow_html=True)
st.markdown('<a href="#" style="display: block; text-decoration: none; color: #2E6EFF; padding: 1rem; border: 1px solid #e0e0e0; border-radius: 8px;" onmouseover="this.style.textDecoration=\'underline\'; this.style.cursor=\'pointer\';" onmouseout="this.style.textDecoration=\'none\';">What’s next after planning?</a>', unsafe_allow_html=True)
st.markdown('</div>', unsafe_allow_html=True)
st.markdown('</div>', unsafe_allow_html=True)
