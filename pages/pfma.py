...
st.markdown("<p>Share John's daily needs to help your advisor prepare.</p>", unsafe_allow_html=True)
...
st.checkbox("Household Confirmed")
...
st.checkbox("Benefits Confirmed")
...
st.checkbox("Personal Info Confirmed")
...
with col2:
    st.button("Book Advisor", key="book_pfma", type="primary")
st.markdown('</div>', unsafe_allow_html=True)
