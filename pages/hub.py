...
st.button("See responses", type="primary")
st.button("Start over", type="secondary")
...
st.button("Get connected", type="primary")
st.markdown('</div>', unsafe_allow_html=True)
...
# Start from scratch
st.button("↻ Start from scratch", type="secondary")
