...
st.markdown("<h2>Here’s what you’ve built for John.</h2>", unsafe_allow_html=True)
...
st.markdown("<p>Your budget breakdown: $1,500/month for John’s care.</p>", unsafe_allow_html=True)
