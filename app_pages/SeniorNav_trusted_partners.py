...
with c2:
    ...
    st.button("Start Test", type="primary", width="stretch")
...
with c1:
    ...
    st.button("Sign Up Free", type="primary", width="stretch")
...
with c2:
    ...
    st.button("Get Quote", type="primary", width="stretch")

st.divider()
if st.button("Back to Waiting Room", width="stretch"):
