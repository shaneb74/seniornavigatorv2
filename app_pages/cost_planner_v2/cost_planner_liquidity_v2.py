# Cost Planner · Liquidity & Gap Planning (v2)
...
def render() -> None:
    st.header("Liquidity & Gap Planning")
    st.caption("Record any monthly gap and how you'll cover it so we can reflect that in your plan.")

    fields = MODULE_FIELD_MAP["liquidity"]
